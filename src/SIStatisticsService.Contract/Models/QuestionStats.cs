...
/// <param name="AnsweredCount">Number of times question was answered.</param>
...
public sealed record QuestionStats(int ShownCount, int PlayerSeenCount, int AnsweredCount, int CorrectCount, int WrongCount);
