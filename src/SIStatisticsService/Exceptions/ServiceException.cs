...
public sealed class ServiceException : Exception
{
    ...
    /// Error code.
    /// </summary>
    public WellKnownSIStatisticServiceErrorCode ErrorCode { get; }
    ...
    public ServiceException(
        WellKnownSIStatisticServiceErrorCode errorCode,
    ...
    public ServiceException(WellKnownSIStatisticServiceErrorCode errorCode, HttpStatusCode statusCode, Exception? innerException)
