...
internal sealed class GamesServiceSourceTests : TestsBase
{
    ...
    public async Task GetPackagesStatisticAsync_WithSourceFilter_PackageWithoutSource_ReturnedWithNullSource()
    {
        ...
        var packagesWithFilter = await GamesService.GetPackagesStatisticAsync(filter, requestedSource);
    ...
    public async Task GetPackagesStatisticAsync_WithSourceFilter_PackageWithDifferentSource_ReturnedWithNullSource()
    {
		...
		var gameResult = new GameResultInfo(new PackageInfo($"Test package different source {randomId}", "hash456", new[] { $"Test author {randomId}" }, null, packageSource))
        {
            Name = $"Test game {randomId}",
            Results = [],
            Reviews = [],
    ...
    public async Task GetPackagesStatisticAsync_WithSourceFilter_PackageWithMatchingSource_Returned()
    {
		...
		var gameResult = new GameResultInfo(new PackageInfo($"Test package matching source {randomId}", "hash789", new[] { $"Test author {randomId}" }, null, packageSource))
        {
            Name = $"Test game {randomId}",
            Results = [],
            Reviews = [],
        ...
        var packagesWithFilter = await GamesService.GetPackagesStatisticAsync(filter, packageSource);
    ...
    public async Task GetPackagesStatisticAsync_WithSourceFilter_PackageWithMultipleSources_FiltersCorrectly()
    {
        ...
        var packagesWithSource1Filter = await GamesService.GetPackagesStatisticAsync(filter, source1);
		...
		var packagesWithSource2Filter = await GamesService.GetPackagesStatisticAsync(filter, source2);
        ...
        var packagesWithNonExistentFilter = await GamesService.GetPackagesStatisticAsync(filter, nonExistentSource);
    ...
    public async Task GetPackagesStatisticAsync_WithSourceFilter_MixedSourceScenario_FiltersCorrectly()
    {
        ...
        var packagesWithTargetSource = await GamesService.GetPackagesStatisticAsync(filter, targetSource);
    ...
    public async Task GetPackagesStatisticAsync_WithoutSourceFilter_PackageWithoutSource_IncludedWithNullSource()
    {
        ...
        var packagesWithoutFilter = await GamesService.GetPackagesStatisticAsync(filter);
